...
function get_debug() {
  ...
  $html = null;
  if(isset($ra->config['debug']['db-num-queries']) && $ra->config['debug']['db-num-queries'] && isset($ra->db)) {
...
function create_url($urlOrController=null, $method=null, $arguments=null) {
  return CRama::Instance()->CreateUrl($urlOrController, $method, $arguments);
}
...
function theme_url($url) {
  return create_url(CRama::Instance()->themeUrl . "/{$url}");
}
...
function theme_parent_url($url) {
  return create_url(CRama::Instance()->themeParentUrl . "/{$url}");
}
...
function render_views($region='default') {
  return CRama::Instance()->views->Render($region);
}
...
function region_has_content($region='default' /*...*/) {
  return CRama::Instance()->views->RegionHasView(func_get_args());
}
